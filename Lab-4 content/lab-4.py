...
layout = [  [sg.Text('Motor Control',  background_color=heading_color)],
			...
			#
			[sg.Text('Pan', background_color=heading_color)],
			
			#
            [sg.Slider(range=(60000,80000), default_value=20, size=(22,15), key='slider1',
             orientation='horizontal', font=('Helvetica', 12),enable_events=True)],	 
			
            #
			[sg.Text('Tilt', background_color=heading_color)],
			
			#
			[sg.Slider(range=(60000,80000), default_value=20, size=(22,15), key='slider2',
             orientation='horizontal', font=('Helvetica', 12),enable_events=True)],	 
